...
export function Sidebar({ open, onToggle }: SidebarProps) {
  ...
  const collapsed = !open;
  const benchmarksTarget = selectedBenchmark
    ? benchmarkPath(selectedBenchmark)
    : "/benchmarks";
